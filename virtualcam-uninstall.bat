...
:uninstallDLLs
	if exist "%~dp0\data\obs-plugins\win-dshow\hyper-virtualcam-module32.dll" (
		regsvr32.exe /u /s "%~dp0\data\obs-plugins\win-dshow\hyper-virtualcam-module32.dll"
	) else (
		regsvr32.exe /u /s hyper-virtualcam-module32.dll
	)
	if exist "%~dp0\data\obs-plugins\win-dshow\hyper-virtualcam-module64.dll" (
		regsvr32.exe /u /s "%~dp0\data\obs-plugins\win-dshow\hyper-virtualcam-module64.dll"
	) else (
		regsvr32.exe /u /s hyper-virtualcam-module64.dll
	)
